...
Create a `.env` file in the project root (or set env vars in your hosting environment) with at least:
...
If you already have a remote MongoDB (you mentioned a medical DB connected in background), set `MONGO_URI` to that connection string. Then run the app as described below.
