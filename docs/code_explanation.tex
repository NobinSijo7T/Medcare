...
\definecolor{frontendcolor}{RGB}{255,182,193}
\definecolor{backendcolor}{RGB}{173,216,230}
\definecolor{databasecolor}{RGB}{144,238,144}
\definecolor{importantcolor}{RGB}{255,215,0}
\definecolor{tipcolor}{RGB}{255,228,181}
\definecolor{sectioncolor}{RGB}{70,130,180}
\definecolor{subsectioncolor}{RGB}{100,149,237}

% Define JavaScript language for listings
\lstdefinelanguage{JavaScript}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, finally, for, function, if, in, instanceof, new, return, switch, this, throw, try, typeof, var, void, while, with, const, let, await, async},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
  morestring=[b]',
...
\newtcolorbox{frontendbox}{
    colback=frontendcolor!20,
    colframe=frontendcolor!80!black,
    title={\textbf{Frontend Component}},
    fonttitle=\bfseries,
    rounded corners
}

\newtcolorbox{backendbox}{
    colback=backendcolor!20,
    colframe=backendcolor!80!black,
    title={\textbf{Backend Component}},
    fonttitle=\bfseries,
    rounded corners
}
...
\newtcolorbox{tipbox}{
    ...
    title={\textbf{Simple Explanation}},
    fonttitle=\bfseries,
    rounded corners
}

\newtcolorbox{importantbox}{
    colback=importantcolor!20,
    colframe=importantcolor!80!black,
    title={\textbf{Important}},
    fonttitle=\bfseries,
    rounded corners
}

\title{{\Huge\textbf{\color{sectioncolor}Pharmacy Management Application}} \\ 
{\Large\color{subsectioncolor}Code Explanation for Beginners}}
\author{{\large\textbf{A Simple Guide for Kids and Beginners}}}
\date{\today}
...
\section{\color{sectioncolor}Introduction - What is This Project?}
...
\section{\color{sectioncolor}Understanding the Main Parts}

Our pharmacy application has two main parts, like two friends working together:

\subsection{\color{frontendcolor!80!black}The Frontend (What You See)}
\begin{frontendbox}
...
\subsection{\color{backendcolor!80!black}The Backend (The Brain)}
\begin{backendbox}
...
\section{\color{sectioncolor}Important Files Explained Simply}
...
\section{\color{sectioncolor}Backend Files - The Storage Room}

\subsection{\color{backendcolor!80!black}Models Folder - The Information Templates}
...
\subsection{\color{backendcolor!80!black}Routes Folder - The Direction Signs}
...
\subsection{\color{backendcolor!80!black}Controllers Folder - The Workers}
...
\section{\color{sectioncolor}Frontend Files - The Shop Display}

\subsection{\color{frontendcolor!80!black}Screens Folder - Different Shop Pages}
...
\section{\color{sectioncolor}Configuration Files}
...
\section{\color{sectioncolor}How It All Works Together}
...
\begin{enumerate}
    ...
    \item \textbf{Backend responds:} The server.js receives the request, routes it to productRoutes.js, which calls productControllers.js to query the database for products
...
\section{\color{sectioncolor}Summary - The Big Picture}

\begin{importantbox}
\textbf{Think of it like a real pharmacy:}
\begin{itemize}
    \item \textbf{\color{frontendcolor!80!black}Frontend = Shop Display:} The colorful store people walk into
    \item \textbf{\color{backendcolor!80!black}Backend = Storage Room \& Manager:} Where products are kept and managed
    \item \textbf{\color{databasecolor!80!black}Database = Big Filing Cabinet:} Where all information is stored safely
