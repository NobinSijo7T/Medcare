...
\begin{tikzpicture}[node distance=3cm, auto]
    ...
    \tikzstyle{database} = [cylinder, shape border rotate=90, aspect=0.25, minimum width=3cm, minimum height=2cm, draw=black, fill=database, text centered, text width=3cm]
...
\begin{tikzpicture}[node distance=2.5cm, auto]
    \tikzstyle{stepbox} = [rectangle, rounded corners, minimum width=6cm, minimum height=1cm, text centered, draw=black, fill=blue!20]
    \tikzstyle{arrow} = [thick,->,>=stealth]
    
    \node (step1) [stepbox] {1. Customer clicks "View Products"};
    \node (step2) [stepbox, below of=step1] {2. Frontend sends request to Backend};
    \node (step3) [stepbox, below of=step2] {3. Backend asks Database for products};
    \node (step4) [stepbox, below of=step3] {4. Database sends product list back};
    \node (step5) [stepbox, below of=step4] {5. Backend sends data to Frontend};
    \node (step6) [stepbox, below of=step5] {6. Frontend shows products on screen};
